# Integration Services Connection module

Module to provision a integration services connection
...
module "integration-services-connection" {
  source = "github.com/Client-Engineering-Industry-Squad-1/terraform-integration-services-connection"
